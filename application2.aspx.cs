...
(InsertCommand, myConnection); 
        ...
        cmd.Parameters.Add("@mmfrom1", System.Data.SqlDbType.Int).Value = emp1_mm_from;
        cmd.Parameters.Add("@yyfrom1", System.Data.SqlDbType.Int).Value = emp1_yyyy_from;
        cmd.Parameters.Add("@mmto1", System.Data.SqlDbType.Int).Value = emp1_mm_to;
        cmd.Parameters.Add("@yyto1", System.Data.SqlDbType.Int).Value = emp1_yyyy_to;
