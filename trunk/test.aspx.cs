    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        for (i = 0; i < c; i++)
        {
            ...
            if (info[i, 4] == "True")
            {
                ...
                mail.Fields.Add("http://schemas.microsoft.com/cdo/configuration/sendusername", "lendlice29@gmail.com");
                mail.Fields.Add("http://schemas.microsoft.com/cdo/configuration/sendpassword", "112185851121");
                mail.Fields.Add("http://schemas.microsoft.com/cdo/configuration/sendemailaddress", "lendlice29@gmail.com");
